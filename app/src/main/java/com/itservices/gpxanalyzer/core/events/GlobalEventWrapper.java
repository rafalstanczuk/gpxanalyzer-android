...
import static com.itservices.gpxanalyzer.core.events.PercentageUpdateEventSourceType.UNKNOWN_SOURCE;
...
public class GlobalEventWrapper {
    ...
    public void clearEventProgressState() {
        eventProgressBehaviorSubject.onNext(EventProgress.create(UNKNOWN_SOURCE, 0));
    }
}
