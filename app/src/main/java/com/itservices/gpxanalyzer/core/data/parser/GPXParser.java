package com.itservices.gpxanalyzer.core.data.parser;

import android.util.Xml;

import com.itservices.gpxanalyzer.core.data.parser.domain.Author;
import com.itservices.gpxanalyzer.core.data.parser.domain.Bounds;
import com.itservices.gpxanalyzer.core.data.parser.domain.Copyright;
import com.itservices.gpxanalyzer.core.data.parser.domain.Email;
import com.itservices.gpxanalyzer.core.data.parser.domain.Extensions;
import com.itservices.gpxanalyzer.core.data.parser.domain.Gpx;
import com.itservices.gpxanalyzer.core.data.parser.domain.Link;
import com.itservices.gpxanalyzer.core.data.parser.domain.Metadata;
import com.itservices.gpxanalyzer.core.data.parser.domain.Point;
import com.itservices.gpxanalyzer.core.data.parser.domain.Route;
import com.itservices.gpxanalyzer.core.data.parser.domain.RoutePoint;
import com.itservices.gpxanalyzer.core.data.parser.domain.Track;
...
import com.itservices.gpxanalyzer.core.data.parser.domain.WayPoint;
...
public final class GPXParser {
    ...
    public static final String TAG_WAY_POINT = "wpt";
