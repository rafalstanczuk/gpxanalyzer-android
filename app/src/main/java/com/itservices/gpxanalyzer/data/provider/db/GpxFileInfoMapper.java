...
public final class GpxFileInfoMapper {
    ...
    public static GpxFileInfoEntity toEntity(GpxFileInfo gpxFileInfo) {
        ...
        GpxFileInfoEntity gpxFileInfoEntity = new GpxFileInfoEntity(
                ...
                gpxFileInfo.firstPointLat(),
                gpxFileInfo.firstPointLon(),
                gpxFileInfo.firstPointEle(),
                gpxFileInfo.firstPointTimeMillis(),
                bitmapBytesBase64,
                gpxFileInfo.fileSize(),
                gpxFileInfo.lastFileModified()
        );
    ...
    public static GpxFileInfo fromEntity(GpxFileInfoEntity entity) {
        ...
        GpxFileInfo gpxFileInfo = new GpxFileInfo(
                ...
                entity.creator(),
                entity.authorName(),
                entity.firstPointLat(),
                entity.firstPointLon(),
                entity.firstPointEle(),
                entity.firstPointTimeMillis(),
                entity.fileSize(),
                entity.lastFileModified()
        );
